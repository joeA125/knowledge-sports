...
Chronological record of all knowledge base operations.## [2026-05-07 17:12] ingest | Attention Is All You Need (Vaswani et al., 2017)
Source: raw/papers/attention-is-all-you-need.md
Pages created: 17 (1 source summary, 9 concepts, 8 entities — 3 organisations, 8 people)
Pages updated: 0
Index updated: yes
Concepts: transformer, attention-mechanism, scaled-dot-product-attention, multi-head-attention, positional-encoding, encoder-decoder, residual-connections, layer-normalization, label-smoothing
Entities: ashish-vaswani, noam-shazeer, niki-parmar, jakob-uszkoreit, llion-jones, aidan-gomez, lukasz-kaiser, illia-polosukhin, google-brain, google-research, university-of-toronto
